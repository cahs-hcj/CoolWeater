...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 21){
            ...
            decorView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);    //改变系统UI
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://goulin.tech/api/weather?cityid=" + weatherId + "&key=4a56eedd946245fcaf55344a45f474ff";
        //组装地址并发出请求
